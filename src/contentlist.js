    ...
    render() {
        const columns = [
            ...
            },
            {
                ...
                render: (record, b) => {
                    ...
                    return (
                        <span>
                            <Switch checkedChildren="显示" unCheckedChildren="隐藏" size='small'
                                    defaultChecked={record.show} onChange={switchChange}/>
        ...
        const pagination = {
            ...
            onChange: (page, pagesize) => {
                // this.props.dispatch({type:'pagechaneg',text:{key1:'pageNo',key1Value:page,key2:'pageSize',key2Value:pagesize,}})
                this.props.dispatch({type: 'searchOptionChange', text: {key: 'pageNo', value: page}})
                this.props.dispatch({type: 'searchOptionChange', text: {key: 'pageSize', value: pagesize}})
                this.props.dispatch({type: 'contentlist'})
            }
        }
        return (
